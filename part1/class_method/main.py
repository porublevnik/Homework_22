...
#                    класса `goods_quantitity`новое значение.
...
#      вычитаем из имеющехся на складе товаров ( аттрибут `goods_quantity` - класса) 
...
#      пожалуйста тоже название `goods_quantity`
#
# 2.2. Если количество имеющихся товаров на складе меньше, 
#      чем запрошено при инициализации класса, тогда
#      вне завимимости от запрашиваемого количества товаров
