...
# перепешите его так, чтобы он стал соответствовать
#
...
# И 2 внутрениие функции:
# - проверяем остался ли товар на складе (check_item)
# - узнаем, сколько товара на складе у нас осталось (check_quantity_limits)
#
# Если какого-то из предметов, которые мы будем хранить 
# на складе будет меньше чем мы запрашиваем, 
# то нужно возвращать все что у нас осталось на складе.
#
