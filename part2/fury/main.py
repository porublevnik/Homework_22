# Придумаем еще одного героя со способностю ярость (fury)
#
# Введем новый класс героя `FuriousHero`, у которого увеличивается атака, 
# когда герой получает урон. При этом его атака не увеличивается если урон
# меньше, чем защита нашего нового героя.
#
# Реализовать нужно отнаследовав класс , 
# переопределить метод _get_damage. 
import random
